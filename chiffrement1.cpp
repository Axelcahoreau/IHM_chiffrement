    ...
    */
    ...
    while (w == 1) {
        ...
        if (x == 1) {
            ...
            cout << "voulez-vous hash� un text(1) ou un fichier(2)  (ou autre chiffre pour revenir a la page d'aceuil) : ";
            cin >> c;

            if (c == 1) {
                cout << "vous avez choisi un text" << endl;
                cout << endl;
                cout << "merci de rentr�e le text : " << endl;
                cin >> text;
                cout << endl;
                cout << "text : " << text << endl;
            ...
            if (c == 2) {
                ...
                cout << endl;
                cout << "merci de rentr�e le chemin et le nom du fichier : " << endl;
                cin >> fich;
                cout << endl;
        ...
        if (x == 2) {
            ...
            if (p == 1) {
                cout << "merci de rentr�e le chemin et le nom du fichier contenent votre clef publique : " << endl;
                cin >> fichpublic;
                ...
                if (c == 1) {
                    cout << "merci de rentr�e le text a encoder : " << endl;
                    cin >> text;
                    cout << "text encoder :" << endl << ha.chiffrementRsa(text) << endl;
                }
                if (c == 2) {
                    cout << "merci de rentr�e le chemin et le nom du fichier a encoder : " << endl;
                    cin >> fichentrer;
                    cout << "merci de rentr�e le nom du fichier de sortie : " << endl;
                    cin >> fichsortie;
            ...
            if (p == 2) {
                ...
                cout << "merci de rentr�e le chemin et le nom du fichier contenent votre clef priver : " << endl;
                cin >> fichpriver;
                ...
                if (t == 2) {
                    ...
                    if (c == 3) {
                        cout << "merci de rentr�e le chemin et le nom du fichier a decoder : " << endl;
                        cin >> fichentrer;
            ...
            if (p == 3) {
                ...
                cin >> fichpriver;
                cout << "merci de rentre la taille de votre cl�f : " << endl;
                cin >> taille;
        ...
        if (x == 3) {
            ...
            cout << "(1) generer clef" << endl << "(2) charger une clef" << endl << "(ou autre chiffre pour revenir a la page d'aceuil)" << endl;
            cin >> c;
